...
export default function Admin(){
  ...
  const submit=async(e)=>{e.preventDefault();setMsg('');try{await api('/api/auth/login',{method:'POST',body:JSON.stringify({email,password})});window.location.href='/admin/dashboard'}catch{setMsg('Login failed')}}
