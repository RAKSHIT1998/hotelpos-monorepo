...
export default function Invoice(){
  ...
  const update=(i,k,v)=>{const c=[...lines];c[i]={...c[i],[k]:v};setLines(c)}
  const submit=async(e)=>{e.preventDefault();const r=await api('/api/invoices',{method:'POST',body:JSON.stringify({currency,lines})});setCreated(r.invoice)}
